                                ...
                                <div className="p-3 rounded-lg bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-900">
                                    <div className="flex items-start gap-2">
                                        ...
                                        <div className="text-xs">
                                            <p className="font-medium text-red-900 dark:text-red-100">YouTube URL detected</p>
                                            <p className="text-red-700 dark:text-red-300">Video will be downloaded and processed</p>
                                        </div>
                                    </div>
                                </div>
                            )}
                            {videoUrl && !isYoutubeUrl(videoUrl) && (
                                <div className="p-3 rounded-lg bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-900">
                                    <div className="flex items-start gap-2">
                                        ...
                                        <div className="text-xs">
                                            <p className="font-medium text-blue-900 dark:text-blue-100">Direct URL detected</p>
                                            <p className="text-blue-700 dark:text-blue-300">Video will be fetched from the provided URL</p>
                                        </div>
                                    </div>
                                </div>
                            )}
